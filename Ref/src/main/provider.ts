    ...
    public async resolveCustomTextEditor(
        ...
        webviewPanel.webview.onDidReceiveMessage((e) => {
            switch (e.type) {
                ...
                case 'client-openLink':
                    vscode.commands.executeCommand("yzc-note.openLink", e.url);
                ...
                //     console.log("Get selection text from milkdown", e.id);
                //     return;
                // }
            }
        });

        registerInsertCommand(webviewPanel);
    }
